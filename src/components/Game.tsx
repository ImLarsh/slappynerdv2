...
export const Game: React.FC = () => {
  ...
  return <div className="fixed inset-0 bg-gradient-to-b from-sky-start to-sky-end overflow-hidden">
      ...
      <div className="hidden lg:block absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute left-[5%] top-0 text-green-400/20 font-mono text-xs animate-matrix-fall-slow">
          1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0
        </div>
        <div className="absolute left-[15%] top-0 text-green-400/15 font-mono text-xs animate-matrix-fall-medium" style={{animationDelay: '1s'}}>
          0<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1
        </div>
        <div className="absolute left-[25%] top-0 text-green-400/20 font-mono text-xs animate-matrix-fall-fast" style={{animationDelay: '2s'}}>
          1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0
        </div>
        <div className="absolute left-[35%] top-0 text-green-400/10 font-mono text-xs animate-matrix-fall-slow" style={{animationDelay: '3s'}}>
          0<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>1<br/>0<br/>1
        </div>
        <div className="absolute left-[45%] top-0 text-green-400/15 font-mono text-xs animate-matrix-fall-medium" style={{animationDelay: '0.5s'}}>
          1<br/>0<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0
        </div>
        <div className="absolute left-[55%] top-0 text-green-400/20 font-mono text-xs animate-matrix-fall-fast" style={{animationDelay: '1.5s'}}>
          0<br/>1<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>1<br/>0
        </div>
        <div className="absolute left-[65%] top-0 text-green-400/10 font-mono text-xs animate-matrix-fall-slow" style={{animationDelay: '2.5s'}}>
          1<br/>1<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>0<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>1
        </div>
        <div className="absolute left-[75%] top-0 text-green-400/15 font-mono text-xs animate-matrix-fall-medium" style={{animationDelay: '3.5s'}}>
          0<br/>0<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>1<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>1
        </div>
        <div className="absolute left-[85%] top-0 text-green-400/20 font-mono text-xs animate-matrix-fall-fast" style={{animationDelay: '4s'}}>
          1<br/>0<br/>1<br/>0<br/>0<br/>0<br/>1<br/>1<br/>0<br/>1<br/>0<br/>1<br/>0<br/>0<br/>1<br/>0
        </div>
        <div className="absolute left-[95%] top-0 text-green-400/10 font-mono text-xs animate-matrix-fall-slow" style={{animationDelay: '4.5s'}}>
          0<br/>1<br/>0<br/>1<br/>1<br/>1<br/>0<br/>0<br/>1<br/>0<br/>1<br/>0<br/>1<br/>1<br/>0<br/>0
        </div>
      </div>
      ...
      height: '100dvh'
        ...
        <div className="relative border-2 sm:border-4 border-border rounded-lg sm:rounded-xl shadow-game bg-gradient-sky overflow-hidden touch-none" style={{
