...
const MainMenu: React.FC = () => {
  ...
  return <>
    <div className="min-h-screen h-screen overflow-hidden bg-cover bg-center bg-no-repeat relative flex flex-col items-center justify-center p-1 sm:p-2 md:p-4" style={{
      ...
      <div className="absolute top-0.5 sm:top-1 md:top-2 lg:top-6 left-0 right-0 z-10 animate-fade-in mx-[95px] py-0 px-0 my-[36px]">
        ...
        <div className="space-y-2 sm:space-y-3 md:space-y-4">
          ...
          <div className="flex flex-col items-center gap-1 sm:gap-2 animate-fade-in" style={{
            ...
            <div className="relative">
              <div className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl hover-scale sm:py-3 md:py-4 lg:py-[21px] my-[8px] mx-0 px-0 py-[16px]">
